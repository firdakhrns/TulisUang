<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="text-2xl font-bold text-slate-800">Tambah Dompet Baru 💰</h2>
            <p class="text-slate-500 text-sm mt-1">Isi data dompet untuk mulai mencatat keuanganmu.</p>
        </div>
    </x-slot>
                ...
                <form action="{{ route('wallets.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" name="name" required
                               ...
                               placeholder="Contoh: Dompet Utama" value="{{ old('name') }}">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="balance" name="balance" required min="0"
                            class="w-full border border-slate-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400"
                            placeholder="Contoh: 500000 (tanpa titik)" value="{{ old('balance') }}">
